...
?>
<h4 class="comment-title">Comments (<?php echo $commentCount; ?>)</h4>
<?php if (have_comments()) :  ?>
    ...
    <?php foreach ($comments as $comment) : ?>
        <div class="comments">
            ...
            <div class="col-md-12 mt-2">
                <h5 class="comment-title"> <?php echo $comment->comment_author; ?></h5>
 ...
 array(
    ...
    '<input type="text" class="mb-4" name="full_name" placeholder="Full name">'.
        ...
        '</p>',
    'comment_notes_after' => '',
    'title_reply' => '<h6 class="title-reply">Leave a reply</h6>'
)); ?>
